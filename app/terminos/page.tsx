  ...
  return (
    <PageShell eyebrow="Información legal" title="Términos y condiciones" description="Reglas claras para utilizar Growtella y sus aplicaciones.">
      <article className="prose mx-auto max-w-3xl px-5 py-16 text-[#4f655b] sm:px-8 sm:py-20">
        <p className="text-sm font-bold text-[#72847c]">Última actualización: septiembre de 2026</p>
        ...
        <h2>Planes y créditos</h2><p>Growtella ofrece los planes mensuales Básico, Pro y Premium. Una misma cuenta puede utilizar los beneficios habilitados en la Calculadora Emprendedora y en las demás aplicaciones compatibles del ecosistema. Los cupos concretos se muestran antes de contratar.</p>
        <h2>Precio, renovación y cancelación</h2><p>Los importes se expresan en dólares estadounidenses y se cobran por adelantado mediante PayPal. La suscripción se renueva automáticamente cada mes hasta que sea cancelada. Podés cancelarla desde tu cuenta de PayPal; mantendrás el acceso hasta finalizar el período ya pagado.</p>
        <h2>Promociones</h2><p>Las promociones disponibles se muestran antes de confirmar el pago. Salvo indicación expresa, no se acumulan entre sí ni se canjean por dinero.</p>
